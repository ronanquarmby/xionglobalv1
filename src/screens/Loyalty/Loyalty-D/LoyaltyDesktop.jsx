    ...
    <div className="Loyalty-d">
      ...
      <div className="main">
        <div className="overlap-6">
          <div className="text-block">
            <div className="HT">
              ...
              <p className="payment-solution-you">
                <span className="a-SIMPLE">TO RETAIN CUSTOMERS{"  "}</span>
          ...
          <img className="element-of" alt="Element of" src="/img/cashback-phone-d.png" />
        </div>
      </div>
        ...
        <div className="TEXT-BLOCK">
          <div className="TEXT"> 
            <div className="frame-3">
              ...
              <p className="text-wrapper-16">ADD A LOYALTY PROGRAM IN 1-CLICK</p>
            </div>
            <p className="text-wrapper-17">
              ...
              customers to stay subscribed for more significant discounts over time. The longer they stay, the more they
              save!
            </p>
          </div>
          ...
          <div className="TEXT">
            <div className="frame-3">
              ...
              <p className="text-wrapper-16">PREDICT YOUR RECURRING REVENUE WITH DISCOUNTS</p>
            </div>
            <p className="text-wrapper-17">
          ...
          <div className="TEXT">
            <div className="frame-3">
              ...
              <div className="text-wrapper-16">SUBSCRIPTION DISCOUNT LEVELS</div>
            </div>
            <p className="text-wrapper-17">
          ...
          <div className="TEXT">
            <div className="frame-3">
              ...
              <div className="text-wrapper-16">HOW XGT DISCOUNTS WORK</div>
            </div>
            <p className="text-wrapper-17">
