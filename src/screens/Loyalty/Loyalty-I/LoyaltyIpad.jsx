          ...
          <div className="text-block">
            <div className="HT">
              ...
              <p className="payment-solution-you">
                <span className="payment-solution-you">TO RETAIN CUSTOMERS{"  "}</span>
                <span className="payment-solution-you">&amp; PREDICT REVENUE</span>
              </p>
            </div>
            <p className="p">
