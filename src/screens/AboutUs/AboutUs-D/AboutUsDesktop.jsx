    ...
    <div className="overlap-21">
      ...
      <div className="section-9">
        ...
        <div className="frame-23">
          <div className="group-13">
            <img className="vector-20" alt="Vector" src="/img/vector-18.svg" />
          </div>
          <div className="group-13">
            <img className="vector-21" alt="Vector" src="/img/vector-19.svg" />
          </div>
          <div className="group-13">
            <img className="vector-22" alt="Vector" src="/img/vector-20.svg" />
          </div>
          <div className="group-13">
            <img className="vector-23" alt="Vector" src="/img/vector-21.svg" />
          </div>
          <div className="group-13">
            <img className="vector-24" alt="Vector" src="/img/vector-22.svg" />
          </div>
          <div className="group-13">
            <img className="vector-25" alt="Vector" src="/img/vector-23.svg" />
          </div>
          <div className="group-13">
            <img className="vector-26" alt="Vector" src="/img/vector-24.svg" />
          </div>
          <div className="group-13">
            <img className="vector-27" alt="Vector" src="/img/vector-25.svg" />
          </div>
          <div className="group-13">
            <img className="vector-28" alt="Vector" src="/img/vector-26.svg" />
          </div>
          <div className="group-13">
            <img className="vector-29" alt="Vector" src="/img/vector-27.svg" />
          </div>
          <div className="group-13">
            <img className="vector-30" alt="Vector" src="/img/vector-28.svg" />
          </div>
          <div className="group-13">
            <img className="vector-31" alt="Vector" src="/img/vector-29.svg" />
          </div>
          <div className="group-13">
            <img className="vector-32" alt="Vector" src="/img/vector-30.svg" />
          </div>
          <div className="group-13">
            <img className="vector-33" alt="Vector" src="/img/vector-31.svg" />
          </div>
          <div className="group-13">
            <img className="vector-34" alt="Vector" src="/img/vector-32.svg" />
          </div>
          <div className="group-13">
            <img className="vector-35" alt="Vector" src="/img/vector-33.svg" />
          </div>
          <div className="group-13">
            <img className="vector-36" alt="Vector" src="/img/vector-34.svg" />
          </div>
          <div className="group-13">
            <img className="vector-37" alt="Vector" src="/img/vector-35.svg" />
          </div>
        </div>
      </div>
      <div className="section-10">
        ...
        <div className="frame-24">
          <img
            className="aaa-ba-e-2"
            alt="Aaa ba e"
            src="/img/a858a9a1-2b5a-4e56-b162-a63f28ad0ece-1592519393391-1-1.png"
          />
          <img className="img-7" alt="Img" src="/img/a2c1b2300bfc675afa30317bba33eb58-1-1.png" />
        </div>
